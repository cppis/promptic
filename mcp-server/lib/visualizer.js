/**
 * PromptLens — HTML Dashboard Visualizer
...
<title>PromptLens — ${escHtml(project.name)}</title>
...
<div class="footer">Generated by PromptLens v0.3.0</div>
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>PromptLens — 전체 대시보드</title>
<script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"></script>
<style>
  :root {
    --bg: #0f172a; --surface: #1e293b; --border: #334155;
