/**
 * Prompatic — HTML Dashboard Visualizer
...
<title>Prompatic — ${escHtml(project.name)}</title>
...
<div class="footer">Generated by Prompatic v0.3.0</div>
